...
const (
	SortBy_ADVERTISED_START_TIME_ASC  SortBy = 0
	SortBy_ADVERTISED_START_TIME_DESC SortBy = 1
	SortBy_NAME_ASC                   SortBy = 2
	SortBy_NAME_DESC                  SortBy = 3
	SortBy_NUMBER_ASC                 SortBy = 4
	SortBy_NUMBER_DESC                SortBy = 5
)
...
type ListRacesRequestFilter struct {
	...
	SortBy      SortBy  `protobuf:"varint,3,opt,name=sort_by,json=sortBy,proto3,enum=racing.SortBy" json:"sort_by,omitempty"`
}
...
func (x *ListRacesRequestFilter) GetSortBy() SortBy {
	if x != nil {
		return x.SortBy
	}
	return SortBy_ADVERTISED_START_TIME_ASC
}
...
var file_racing_racing_proto_rawDesc = []byte{
	...
	0x63, 0x65, 0x73, 0x22, 0x85, 0x01, 0x0a, 0x16, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x61, 0x63, 0x65,
	...
	0x6c, 0x79, 0x12, 0x27, 0x0a, 0x07, 0x73, 0x6f, 0x72, 0x74, 0x5f, 0x62, 0x79, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x0e, 0x32, 0x0e, 0x2e, 0x72, 0x61, 0x63, 0x69, 0x6e, 0x67, 0x2e, 0x53, 0x6f, 0x72,
	0x74, 0x42, 0x79, 0x52, 0x06, 0x73, 0x6f, 0x72, 0x74, 0x42, 0x79, 0x22, 0xcb, 0x01, 0x0a, 0x04,
	...
	0x53, 0x74, 0x61, 0x72, 0x74, 0x54, 0x69, 0x6d, 0x65, 0x2a, 0x85, 0x01, 0x0a, 0x06, 0x53, 0x6f,
	...
	0x05, 0x32, 0x4c, 0x0a, 0x06, 0x52, 0x61, 0x63, 0x69, 0x6e, 0x67, 0x12, 0x42, 0x0a, 0x09, 0x4c,
...
var file_racing_racing_proto_depIdxs = []int32{
	...
	0, // 2: racing.ListRacesRequestFilter.sort_by:type_name -> racing.SortBy
